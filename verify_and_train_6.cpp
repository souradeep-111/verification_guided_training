...
int main(int argc, char ** argv)
{
  ...
  // sherlock_parameters.verbosity = true;
    ...
    bool prove_invariancy = true;
    int invariancy_steps = 8;
    ...
    state_interval[0][0] = -1;state_interval[0][1] = 1;
    state_interval[1][0] = -1;state_interval[1][1] = 1;
    state_interval[2][0] = -1;state_interval[2][1] = 1;
  ...
  string controller_network_filename("./network_files/control_ex_18_3d/controller.nt");
  ...
  char state_vars_file[] = "./network_files/control_ex_18_3d/neural_network.nt" ;
  ...
  merge_networks(control_bounds[0][0], 1, closed_loop_file, state_vars_file, controller_file);
  ...
  vector< datatype > scaling_factor(state_space_dim + extra_directions, 1);
  ...
  vector< datatype > scale_vector_input(state_space_dim + extra_directions, 1.0);

  vector< datatype > scale_vector_output(state_space_dim + extra_directions, 1.0);
  ...
  constraint[0] = -1; constraint[1] = 0; constraint[2] = 0; constraint[3] = 0.1;
