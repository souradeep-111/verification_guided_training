...
{
  sherlock_parameters.gradient_rate = 1e-2; //-2
  sherlock_parameters.grad_scaling_factor = 1; //2e1
  sherlock_parameters.grad_switch_count = 1e2; // 1e2
  sherlock_parameters.grad_termination_limit = 1e-6;
  sherlock_parameters.MILP_M = 1e10; // 5
  sherlock_parameters.MILP_tolerance = 1e-3;
  sherlock_parameters.MILP_e_tolerance = 1e-10;

    auto state_space_dim = 3;
    auto control_dim = 1;
    auto hidden_nodes = 10;
    auto no_of_initial_points = 100;
    auto no_of_steps = 12;
    auto no_of_unrollings = 2;
    auto acc_in_reach_sets = 6;
    auto no_of_extra_directions = 4;
    bool only_simulate = false;
    int invariancy_steps = 6;
    double learning_rate = 1e-4;
    int episodes = 1000;
    int batch_size = 20;

    // Number of retrainings = 2
  ...
  string controller_network_filename("./network_files/control_ex_15_3d/controller.nt");
  ...
  char state_vars_file_1[] = "./network_files/control_ex_15_3d/neural_network_information_1" ;
  char state_vars_file_2[] = "./network_files/control_ex_15_3d/neural_network_information_2" ;
  char state_vars_file_3[] = "./network_files/control_ex_15_3d/neural_network_information_3" ;
  ...
  char name[] = "./network_files/control_ex_15_3d/state_vars";
  write_network_to_file(w_4, b_4, name);

  char state_vars_file[] = "./network_files/control_ex_15_3d/state_vars" ;
  ...
  char closed_loop_file[] = "./network_files/control_ex_15_3d/composed_network_non_linear";
  ...
  control_bounds[0][0] = -10;
  control_bounds[0][1] = 10;
  ...
  biases_now[2][0] = -0.4;biases_now[2][1] = -0.35;
  ...
  constraint[0] = 0; constraint[1] = -1;constraint[2] = 0; constraint[3] = 0.05;
  target_region.push_back(constraint);
  ...
  constraint[0] = 0; constraint[1] = 0; constraint[2] = -1; constraint[3] = 0.05;
  target_region.push_back(constraint);
  ...
  cout << "All simulation and plotting ends -------------- " << endl;
    ...
    biases_now[2][0] = -0.05;biases_now[2][1] = 0.05;
    biases_now[3][0] = -10;biases_now[3][1] = 10;
    biases_now[4][0] = -10;biases_now[4][1] = 10;
    biases_now[5][0] = -10;biases_now[5][1] = 10;
    biases_now[6][0] = -10;biases_now[6][1] = 10;
