...
int main(int argc, char ** argv)
{
  ...
  //
    ...
    auto state_space_dim = 3;
    auto control_dim = 1;
    auto hidden_nodes = 21; // 60
    auto no_of_initial_points = 1000;
    auto no_of_steps = 30;
    auto no_of_unrollings = 2; // 12
    auto acc_in_reach_sets = 3;
    auto no_of_extra_directions = 4;
    bool only_simulate = false;
    int invariancy_steps = 11;
    ...
    // state_interval[0][0] = -1.5;state_interval[0][1] = 1.5;
    // state_interval[1][0] = -1.5;state_interval[1][1] = 1.5;
    // state_interval[2][0] = -1.5;state_interval[2][1] = 1.5;

    state_interval[0][0] = -1.0;state_interval[0][1] = 1.0;
    state_interval[1][0] = -1.0;state_interval[1][1] = 1.0;
    state_interval[2][0] = -1.0;state_interval[2][1] = 1.0;
  ...
  string controller_network_filename("./network_files/control_ex_17_3d/controller.nt");
  ...
  // char state_vars_file_1[] = "./network_files/control_ex_17_3d/neural_network_information_1" ;
  // char state_vars_file_2[] = "./network_files/control_ex_17_3d/neural_network_information_2" ;
  // char state_vars_file_3[] = "./network_files/control_ex_17_3d/neural_network_information_3" ;
  //
  ...
  //
  // char name[] = "./network_files/control_ex_17_3d/state_vars";
  // write_network_to_file(w_4, b_4, name);

  // char state_vars_file[] = "./network_files/control_ex_17_3d/state_vars" ;
  char state_vars_file[] = "./network_files/control_ex_17_3d/neural_network.nt" ;
  ...
  char closed_loop_file[] = "./network_files/control_ex_17_3d/composed_network_non_linear";


  merge_networks(-3, 1, closed_loop_file, state_vars_file, controller_file);
  ...
  control_bounds[0][0] = -3;
  control_bounds[0][1] = 3;
  ...
  vector< datatype > scale_vector_input(state_space_dim + extra_directions, 1);

  vector< datatype > scale_vector_output(state_space_dim + extra_directions, 1);
  ...
  constraint[0] = -1; constraint[1] = 0; constraint[2] = 0; constraint[3] = 0.05;
  ...
  constraint[0] = 0; constraint[1] = -1;constraint[2] = 0; constraint[3] = 0.025;
  target_region.push_back(constraint);
  ...
  constraint[0] = 0; constraint[1] = 0; constraint[2] = -1; constraint[3] = 0.06;
  target_region.push_back(constraint);
  ...
  cout << "All simulation and plotting ends -------------- " << endl;
    ...
    biases_now[0][0] = -0.05;biases_now[0][1] = 0.05;
    biases_now[1][0] = -0.025;biases_now[1][1] = 0.025;
    biases_now[2][0] = -0.06;biases_now[2][1] = 0.06;
    biases_now[3][0] = -10;biases_now[3][1] = 10;
    biases_now[4][0] = -10;biases_now[4][1] = 10;
    biases_now[5][0] = -10;biases_now[5][1] = 10;
    biases_now[6][0] = -10;biases_now[6][1] = 10;
