...
int main(int argc, char ** argv)
{
    ...
    auto control_dim = 1;
    auto hidden_nodes = 40;
    auto no_of_initial_points = 50;
    auto no_of_steps = 40;
    auto no_of_unrollings = 2;
    auto acc_in_reach_sets = 2;
    auto no_of_extra_directions = 1;
    bool only_simulate = false;
    int invariancy_steps = 4;
  ...
  string controller_network_filename("./network_files/control_ex_13_2d/controller.nt");
  ...
  char state_vars_file_1[] = "./network_files/control_ex_13_2d/neural_network_information_1" ;
  char state_vars_file_2[] = "./network_files/control_ex_13_2d/neural_network_information_2" ;
  ...
  char name[] = "./network_files//control_ex_13_2d/state_vars";
  write_network_to_file(w_4, b_4, name);

  char state_vars_file[] = "./network_files/control_ex_13_2d/state_vars" ;
  ...
  char closed_loop_file[] = "./network_files/control_ex_13_2d/composed_network_non_linear";
  ...
  biases_now[0][0] = 0.7;biases_now[0][1] = 0.75;
  biases_now[1][0] = 0.8;biases_now[1][1] = 0.85;
  ...
  // x_0 < 0.1 ... [ -x_0 + 0 x_1 + 0.1 > 0 ]
  constraint[0] = -1; constraint[1] = 0; constraint[2] = 0.1;
  ...
  // x_1 < 0.1 ... [ 0 x_0 + (-1) x_1 + 0.1 > 0 ]
  constraint[0] = 0; constraint[1] = -1; constraint[2] = 0.1;
  target_region.push_back(constraint);

  // x_1 > -0.1 ... [ 0 x_0 + x_1 + 0.1 > 0 ]
  constraint[0] = 0; constraint[1] = 1;constraint[2] = 0.1;
  target_region.push_back(constraint);
  ...
  cout << " ------------------------------------------------------------ " << endl;
  simulate_system_and_create_plots(no_of_steps, system_network, 1, important_outputs,
  ...
  biases_now[0][0] = -0.1;biases_now[0][1] = 0.1;
